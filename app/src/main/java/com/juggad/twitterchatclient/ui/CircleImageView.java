...
public class CircleImageView extends android.support.v7.widget.AppCompatImageView {
    ...
    public CircleImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mBorderWidth = a.getDimensionPixelSize(R.styleable.CircleImageView_circleimageview_border_width,
                DEFAULT_BORDER_WIDTH);
        mBorderColor = a.getColor(R.styleable.CircleImageView_circleimageview_border_color, DEFAULT_BORDER_COLOR);
        mBorderOverlay = a
                .getBoolean(R.styleable.CircleImageView_circleimageview_border_overlay, DEFAULT_BORDER_OVERLAY);
